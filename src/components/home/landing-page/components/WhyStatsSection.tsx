...
import { TrendingUp, Users, AlertTriangle, Newspaper, Megaphone, GraduationCap, AlertCircle } from 'lucide-react';

const WhyStatsSection = () => {
    ...
    <section id="problem-section" className="py-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            Artificial intelligence is flooding social media with fake content, threatening authenticity and trust
        ...
        {/* Animated Statistics */}
        <div
          className={`grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 transform transition-all duration-1000 delay-400 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
        >
...
export default WhyStatsSection;
